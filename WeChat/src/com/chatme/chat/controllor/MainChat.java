...
import com.chatme.chat.mode.Phone;
import com.chatme.chat.mode.PhoneNumber;
...
//		
//		Phone phone = new Phone(MainChat.this);
...
//		}
//		
//		adapter = new SimpleAdapter(MainChat.this, list,
...
//		gridView1= (ListView) ll_phonenumber.findViewById(R.id.gridView);
//    	gridView1.setAdapter(adapter);
	...
	public void startchat(View view) {      //小黑  对话界面
		Intent intent = new Intent (MainChat.this,ChatActivity.class);			
		startActivity(intent);	
		//Toast.makeText(getApplicationContext(), "登录成功", Toast.LENGTH_LONG).show();
      }  
	public void exit_settings(View view) {                           //退出  伪“对话框”，其实是一个activity
		Intent intent = new Intent (MainChat.this,ExitFromSettings.class);			
		startActivity(intent);	
	 }
	//addfriend
	public void addFriend(View view){
		Toast.makeText(this, "正在获取本地相关账号！", Toast.LENGTH_LONG).show();
		Intent intent = new Intent(MainChat.this,PhoneNumber.class);
		startActivity(intent);
	}
	//摇一摇
	public void btn_shake(View view) {                                   //手机摇一摇
		Intent intent = new Intent (MainChat.this,ShakeActivity.class);			
		startActivity(intent);	
	}
	//main_tab_address界面中的   groupChat  的点击事件
	...
	public void myInfo(View view){
		Intent intent = new Intent(MainChat.this,InfoMy.class);
		startActivity(intent);
	}
	//main_tab_settings 界面中生成二维码(二维码名片)
	public void startQRCode(View view){
		Intent intent = new Intent(MainChat.this,QRCode.class);
		startActivity(intent);
	}
	//tencent微博
	public void tencentWeiBo(View view){
		Uri uri =Uri.parse("http://weibo.com");
		Intent intent = new Intent();
